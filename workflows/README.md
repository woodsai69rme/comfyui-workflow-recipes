...
| # | Workflow | File | VRAM | Time |
|---|---|---|---|---|
| 1 | Text-to-Image (SDXL) | `01_sdxl_text2image.json` | 4.2 GB | 8s |
| 2 | Image-to-Image (SDXL) | `02_sdxl_img2img.json` | 4.5 GB | 10s |
| 3 | Text-to-Video (Wan 2.1) | `03_wan_text2video.json` | 6.8 GB | 45s |
| 4 | Beat-Synced Music Video | `04_beat_synced_music_video.json` | 7.2 GB | 2-5 min |
| 5 | Video Style Transfer | `05_video_style_transfer.json` | 5.8 GB | 30s/frame |
| 6 | Character Consistency Pipeline | `06_character_consistency.json` | 6.2 GB | 20s |
| 7 | Upscale + Frame Interpolation | `07_upscale_interpolation.json` | 3.5 GB | 15s |
